...
% T5 is needed only so the real Vietnamese names in a_group_intro.tex
% render correctly. \vnname{...} switches to it for just that text so
% the rest of the (English) report keeps default T1 hyphenation rules.
