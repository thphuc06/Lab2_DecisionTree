...
train/test split (the project's shared stratified train/test split)
...
\begin{figure}[H]
  ...
  885-sample held-out test set. M2b correctly classifies 201 Dropout and 74 Enrolled students, exceeding both M0 (193, 61) and M2a (193, 54). It correctly classifies 334 Graduate students, more than M2a (329) but fewer than M0 (338).}
  \label{fig:cm-m2b}
\end{figure}
