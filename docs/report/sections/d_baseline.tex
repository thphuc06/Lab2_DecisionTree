...
\todo{Describe the baseline model (\texttt{DecisionTreeClassifier(random\_state=42)}, no constraints, Gini criterion), and the train/test procedure using the shared \texttt{src.data.get\_train\_test()} split (3,539 train / 885 test).}
