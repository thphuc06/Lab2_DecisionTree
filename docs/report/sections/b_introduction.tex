...
categories have been encoded, trees handle the resulting numerical and
indicator features without feature scaling -- both properties are
exploited directly in Section~\ref{sec:c} below.
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textbf{Feature selection for early warning} -- addresses a
      ...
      intervention.
  \end{itemize}
  \item Quantitatively compares all five model configurations and draws conclusions
