% Final section; quantitative claims were checked against the canonical
% experiment artifacts before submission.
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textbf{Feature selection for early warning}: addresses a
      practical limitation. Semester outcomes are unavailable at enrollment,
      so the model with the highest accuracy is not necessarily the model best
      suited to that earliest intervention point. Operational feasibility of
      the retained variables remains conditional on the feature-availability
      assumption stated in Section~\ref{sec:f3}.
  \end{itemize}
